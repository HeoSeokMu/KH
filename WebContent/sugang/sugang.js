...
/*				var sum = Number(document.getElementsByName("subject_sum")[0].value); // 과목수 뺄셈
	...
	function selectRadio(select, m_code, y_grade, stu_num, semester) {
		
		
		var param = "m_code="+m_code+"&y_grade="+y_grade+"&stu_num="+stu_num+"&semester="+semester;
	...
	function selectSearch(search_sugang, search, stu_num, semester ) {
		
		
		var param = "search_sugang="+search_sugang+"&search="+search+"&stu_num="+stu_num+"&semester="+semester;
		...
		xmlhttp.open("GET", "sugangSearch.kh?"+param, true);			

		
		xmlhttp.send();selectSearch
	}
