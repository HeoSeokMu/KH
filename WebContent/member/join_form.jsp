		...
		<table border=1 align="center">
			...
			<tr bgcolor="BBEE99" height=40>
				...
				<td>
					...
					-
					<input type="text" name="phone2" size=7 value="" onchange="phone_CHECK(this.form)">
			...
			<tr bgcolor="BBEE99" height=40>
				...
				<td>
					&nbsp;&nbsp;
					<select name="s_tel_sel">
						<option value="KT" checked>KT</option>
						<option value="SKT">SKT</option>
						<option value="LGT">LGT</option>
					</select>
					<select name="s_phone_number_sel">
						<option value="010">010</option>
						<option value="011">011</option>
						<option value="016">016</option>
						<option value="017">017</option>
					</select>
					<input type="text" name="s_phone1" size=7 value="">
					-
					<input type="text" name="s_phone2" size=7 value="" onchange="phone_CHECK(this.form)">
					<input type="hidden" name="s_phonenumber">
				</td>
			</tr>
			<tr bgcolor="BBEE99" height=40>
