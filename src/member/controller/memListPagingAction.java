...
public class memListPagingAction {
	...
	// 페이징 생성자
	public memListPagingAction(int currentPage, int totalCount, int blockCount, int blockPage) {
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a href=memberList.kh?currentPage=" + (startPage - 1) + ">");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				System.out.println("i : " + i);
				pagingHtml.append("&nbsp;<a href=memberList.kh?currentPage=");
				pagingHtml.append(i);
				pagingHtml.append(">");
				pagingHtml.append(i);
				pagingHtml.append("</a>");
		...
		if (totalPage - startPage >= blockPage) {
			pagingHtml.append("<a href=memberList.kh?currentPage=" + (endPage + 1) + ">");
