...
public class vacationResultPagingAction {
	...
	// 페이징 생성자
	public vacationResultPagingAction(int currentPage, int totalCount, int blockCount, int blockPage) {
		...
		if (currentPage > blockPage) {
			pagingHtml.append("<a href=vacationResult.kh?currentPage=" + (startPage - 1) + ">");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				System.out.println("i : " + i);
				pagingHtml.append("&nbsp;<a href=vacationResult.kh?currentPage=");
				pagingHtml.append(i);
				pagingHtml.append(">");
				pagingHtml.append(i);
				pagingHtml.append("</a>");
		...
		if (totalPage - startPage >= blockPage) {
			pagingHtml.append("<a href=vacationResult.kh?currentPage=" + (endPage + 1) + ">");
